...
namespace NerdDinner.Models
{
    ...
    partial void OnLatitudeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[Description ]", Storage="_Description_", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		public string Description_
		{
			...
			set
			{
				if ((this._Description_ != value))
				{
					this.OnDescription_Changing(value);
					this.SendPropertyChanging();
					this._Description_ = value;
					this.SendPropertyChanged("Description_");
